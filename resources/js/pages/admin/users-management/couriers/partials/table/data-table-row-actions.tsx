...
export function DataTableRowActions({ row }: { row: Row<Courier> }) {
    const handleDelete = (courierId: number) => {
        router.delete(route('admin.couriers.destroy', { id: courierId }), {
            onSuccess: () => {
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[160px]">
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>Data Karyawan Kurir</DialogTitle>
                            </DialogHeader>
                            <CourierData data={row.original} />
                            <DialogFooter>
                                <DialogClose asChild>
...
function CourierData({ data }: { data: Courier }) {
    return (
        <>
            <div>
