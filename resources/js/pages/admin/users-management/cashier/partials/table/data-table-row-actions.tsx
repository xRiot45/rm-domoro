...
export function DataTableRowActions({ row }: { row: Row<Cashier> }) {
    const handleDelete = (cashierId: number) => {
        router.delete(route('admin.cashiers.destroy', { id: cashierId }), {
            onSuccess: () => {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[160px]">
                    <Link href={route('admin.cashiers.edit', { id: row.original.id })} className="cursor-po">
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>Data Karyawan Kasir</DialogTitle>
                            </DialogHeader>
                            <CashierData data={row.original} />
                            <DialogFooter>
                                <DialogClose asChild>
...
function CashierData({ data }: { data: Cashier }) {
    return (
        <>
            <div>
