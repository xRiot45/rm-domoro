...
interface ExpenseRangeFilterProps<TData, TValue> {
    column: Column<TData, TValue>;
    title?: string;
}

export function ExpenseRangeFilter<TData, TValue>({ column, title = 'Tanggal' }: ExpenseRangeFilterProps<TData, TValue>) {
