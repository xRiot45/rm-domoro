                                ...
                                <CardContent className="space-y-4 p-6 lg:p-8">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <p className="text-muted-foreground capitalize">
                                                {data?.customer?.user?.full_name || data?.recipient || '-'}
                                            </p>
                                        </div>
                                        <div>
                                            <h1 className="font-bold">Nomor Telepon Penerima</h1>
                                            <p className="text-muted-foreground capitalize">
                                                {data?.customer?.user?.phone_number || data?.recipient_phone_number || '-'}
                                            </p>
                                        </div>
                                        <div>
                                            <h1 className="font-bold">Catatan Untuk Kurir</h1>
                                            <p className="text-muted-foreground capitalize">{data?.customer?.note || data?.note || '-'}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted-foreground">{data?.customer?.address || data?.shipping_address || '-'}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <p className="font-bold">Nomor Meja</p>
                                            <p className="text-muted-foreground capitalize">{data?.table_number || '-'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span>{formatCurrency(data?.service_charge ?? 0)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="font-bold">Diskon</span>
                                            <span className="text-red-500">-{formatCurrency(data?.discount ?? 0)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                        ...
                                        {data?.payment_method === PaymentTypeEnum.CASH && (
                                            <>
                                                <div className="flex justify-between">
                                                    ...
                                                    <span>{formatCurrency(data?.cash_received ?? 0)}</span>
                                                </div>
                                                <div className="flex justify-between">
